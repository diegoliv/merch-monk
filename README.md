...
| Attribute | 3D target |
| --- | --- |
| `data-texture-crewneck-logo` | Crewneck logo/emissive map |
| `data-texture-box-body` | Outer box body |
| `data-texture-box-bottle-logo` | Bottle/cup inside the box |
| `data-texture-box-notebook-logo` | Notebook inside the box |

```html
<div
  class="canvas-layer_middle"
  data-texture-crewneck-logo="https://cdn.prod.website-files.com/69fb6de67bc0fb48b4ab0147/6a5527787af01c167ce42d3c_f488968c6e31020e99fcf5deeeb44ad6_crewneck-logo.avif"
  data-texture-box-body="https://cdn.prod.website-files.com/69fb6de67bc0fb48b4ab0147/6a5a88f85ff267f9a82727a8_box_body.avif"
  data-texture-box-bottle-logo="https://cdn.prod.website-files.com/69fb6de67bc0fb48b4ab0147/6a613ce5aa236d5e3064fef2_bottle-logo.avif"
  data-texture-box-notebook-logo="https://cdn.prod.website-files.com/69fb6de67bc0fb48b4ab0147/6a613ce50330e513548c5356_notebook-logo.avif"
></div>
```

Replacing an asset in Webflow changes its URL. Copy the new asset link into the corresponding attribute and republish the Webflow page; no JavaScript rebuild is required.
...
- Default external texture URLs live in `src/three/sceneTextureUrls.ts`; Webflow can override them through the `data-texture-*` attributes on the canvas host.
